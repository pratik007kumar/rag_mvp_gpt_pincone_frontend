          ...
          <div className="mb-4">
            <p className="text-xs text-gray-400 uppercase tracking-wide px-3 py-1 flex items-center justify-between">
              ...
              {documents.documents.length > 0 && (
                <span className="text-gray-500 normal-case">{documents.documents.length}</span>
              )}
            </p>
            {documents.documents.length === 0 ? (
              ...
              documents.documents.map(doc => (
                <div key={doc.id} className="flex items-center justify-between py-2.5 px-3 border-b border-gray-100 hover:bg-gray-50 group transition-colors duration-150">
                  <div className="min-w-0 flex-1 flex items-center">
                    <svg className="w-4 h-4 text-blue-500 mr-2 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
